...
from plotregions import regionsplots,generate_origheatmapindex,generate_origheatmap,generate_predheatmap,wholeregion,deathindia,casesindia,generate_predheatmapindex
import numpy as np
...
@app.route("/")
def home():
    generate_predheatmapindex()
    generate_origheatmapindex()
    casesindia()
    deathindia()
    regionsplots()
    wholeregion()
    generate_origheatmap()
    generate_predheatmap()
...
def mumbai():
    ...
    for i in morning:
        ...
        email=(result['email'])
        slot=(result['slot'])
        res1.append((username+" "+phone+" "+email+" morning"))
        print(res1)
    ...
    for i in afternoon:
        ...
        res2.append((username+" "+phone+" "+email+ " afternoon"))
    ...
    for i in evening:
        ...
        res3.append((username+" "+phone+" "+email+ " evening"))
